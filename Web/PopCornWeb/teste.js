let movies = [
  ...
  },
  {
    ...
    Plot: "The story behind Detective James Gordons rise to prominence in Gotham City in the years before Batmans arrival.",
    Language: "English",
    Country: "USA",
  ...
  },
  {
    ...
    Plot: "James GhostSt. Patrick, a wealthy New York night club owner who has it all, catering for the citys elite and dreaming big, lives a double life as a drug kingpin.",
    Language: "English",
    Country: "USA",
  ...
  },
  {
    ...
    Plot: "A high school chemistry teacher diagnosed with inoperable lung cancer turns to manufacturing and selling methamphetamine in order to secure his familys financial future.",
    Language: "English, Spanish",
    Country: "USA",
...
for (let i = 0; i < movies.length; i++) {
  ...
  base.title = movies[i].Title;
  base.image = movies[i].Images[0];
  base.description = movies[i].Plot.substring(0, 30).replaceAll("'", "");
  let runtime = Number(movies[i].Runtime.split(" ")[0]);
